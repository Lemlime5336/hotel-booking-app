...
const AddRoom = () => {
  ...
  return (
    <form>
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the room details, pricing and amenities.'/>
      {/* Image Uploads */}
      ...
      <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
        {Object.keys(inputs.amenities).map((amenity, index)=>(
          <div key={index}>
              ...
              <label htmlFor={`amenities${index+1}`} className='ml-1'>   {amenity}</label>
          </div>
        ))}
      </div>
