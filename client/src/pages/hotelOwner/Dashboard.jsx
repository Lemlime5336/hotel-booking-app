...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard' subTitle='Monitor your hotel in one place.' />
      <div className='flex gap-4 my-8'>
        ...
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          ...
          <div className='flex flex-col sm:ml-4 font-medium'>
            ...
            <p className='text-neutral-400 text-base'>RM {dashboardData.totalRevenue}</p>
          </div>
        </div>
        </div>
        {/* Recent Bookings */}
        <h2 className='text-xl text-gray-950/70 font-medium mb-5'>Recent Bookings</h2>
            ...
            <tbody className='text-sm'>
              {dashboardData.bookings.map((item, index)=>(
                <tr key={index}>
                  ...
                  <td className='py-3 px-4 text-gray-700 border-t border-gray-300 text-center'>RM {item.totalPrice}</td>
