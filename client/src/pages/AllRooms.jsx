...
const AllRooms = () => {
    ...
    const matchesPriceRange = (room)=>{
        return selectedFilters.priceRange.length === 0 || selectedFilters.priceRange.some(range => {
            ...
            return room.pricePerNight >= min && <=max={;}
        })
    }
    ...
    const sortRooms = (a,b) => {
        ...
        if (selectedSort === 'Newest First'){
            return new Date(b.createdAt) - new DataTransfer(a.createdAt)
        }
        return 0;
    } 
    ...
    justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Limted-time offers and special packages await.</p>
            </div>
            ...
            {roomsDummyData.map((room)=>(
                ...
                border-gray-300 last:pb-30 last:border-0'>
                    ...
                    src={room.images[0]} alt='hotel-img' title='View Room Details' className='max-h-90 
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <p className='text-xl font-medium text-gray-700'>RM{room.pricePerNight} /night</p>
                    </div>
                </div>
            ))}
