...
const AllRooms = () => {
    ...
    const sortRooms = (a, b) => {
        if(selectedSort === 'Price: Low - High') return a.pricePerNight - b.pricePerNight;
        if(selectedSort === 'Price: High - Low') return b.pricePerNight - a.pricePerNight;
        ...
        justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div>
                <div className='flex flex-col items-start text-left'>
                    ...
                    <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Limited-time offers and special packages await.</p>
                </div>
