    ...
    <Link to={'/rooms/' + room._id} onClick={()=> scrollTo(0,0)} key={room._id}>
        ...
        <div className="p-4 pt-5">
            ...
            <div className='flex items-center justify-between mt-4'>
                <p><span className='text-xl text-gray-800'>RM{room.pricePerNight}</span>/night</p>
                <button className='px-4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-grau-50 transition-all cursor-pointer'>Book Now</button>
            </div>
        </div>
